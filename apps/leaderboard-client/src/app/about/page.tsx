...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-6 px-2 py-4 text-white sm:px-0 sm:space-y-8 sm:py-6">
      {/* Header */}
      <header className="space-y-3 sm:space-y-4">
        {/* <h1 className="text-4xl font-bold">MyTwin <span className="text-brandCP">Lab</span></h1> */}
        <h2 className="text-xl font-semibold text-white sm:text-2xl">A global movement to reinvent health. Together.</h2>
      </header>
      ...
      <section className="space-y-2 text-sm text-white/80 sm:space-y-3 sm:text-base">
        ...
        <p className="font-semibold text-brandCP">#WeAreNotWaiting</p>
      </section>
      ...
      {/* What is MyTwin Lab */}
      <section className="space-y-2 sm:space-y-3">
        <h2 className="text-xl font-semibold sm:text-2xl">What is MyTwin Lab?</h2>
        <p className="text-sm text-white/80 sm:text-base">MyTwin Lab is the <strong className="text-white">innovation engine</strong> powering MyTwin.</p>
        <p className="text-sm text-white/80 sm:text-base">It is a radically open, global, collaborative ecosystem where anyone can contribute to the future of health technology.</p>
        <p className="text-sm text-white/80 sm:text-base">We work like an open-source movement, but instead of tools and libraries, we build:</p>
        <ul className="ml-4 list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
        ...
        <p className="mt-3 text-sm text-white/80 sm:mt-4 sm:text-base">MyTwin Lab combines:</p>
        <ul className="ml-4 list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
        ...
        <p className="mt-3 text-sm text-white/80 sm:mt-4 sm:text-base">If you care about building the future of health, you belong here.</p>
      </section>
      ...
      {/* Why we exist */}
      <section className="space-y-2 sm:space-y-3">
        <h2 className="text-xl font-semibold sm:text-2xl">Why we exist</h2>
      ...
      <section className="space-y-2 sm:space-y-3">
        <h2 className="text-xl font-semibold sm:text-2xl">How the Leaderboard transforms collaboration</h2>
        <p className="text-sm text-white/80 sm:text-base">The AI agent:</p>
        <ul className="ml-4 list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
      ...
      <section className="space-y-3 sm:space-y-4">
        <h2 className="text-xl font-semibold sm:text-2xl">What you can contribute (and how the AI recognizes it)</h2>
        <p className="text-sm text-white/80 sm:text-base">Innovation is not one-dimensional. The Lab values all forms of contributions:</p>

        <div className="mt-3 space-y-3 sm:mt-4 sm:space-y-4">
          <div>
            <h3 className="text-base font-semibold sm:text-lg">Build things</h3>
            <p className="text-sm text-white/80 sm:text-base">Code, design, branding, data, research, AI, product, writing… Anything that creates or improves a real piece of MyTwin.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-white/80 sm:text-base">Researchers, entrepreneurs, startups can launch initiatives. The Leaderboard tracks the ripple effect of everything you build.</p>
          </div>
          <div>
      ...
      {/* Who can join */}
      <section className="space-y-2 sm:space-y-3">
        <h2 className="text-xl font-semibold sm:text-2xl">Who can join?</h2>
        <p className="text-sm text-white/80 sm:text-base">Anyone. Truly anyone.</p>
        <ul className="ml-4 list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
        ...
        <p className="mt-3 text-sm text-white/80 sm:mt-4 sm:text-base">No expertise required. You grow by contributing.</p>
      </section>
      ...
      {/* Values */}
      <section className="space-y-3 sm:space-y-4">
        <h2 className="text-xl font-semibold sm:text-2xl">Our values</h2>
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
          <div>
            <h3 className="text-sm font-semibold sm:text-base">Collective &gt; Individual</h3>
            <p className="text-xs text-white/80 sm:text-sm">Breakthroughs emerge from collaboration.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-xs text-white/80 sm:text-sm">Knowledge grows by being shared.</p>
          </div>
          <div>
            <h3 className="text-sm font-semibold sm:text-base">Transparency &gt; Politics</h3>
            <p className="text-xs text-white/80 sm:text-sm">Every contribution is visible and measurable.</p>
          </div>
          <div>
            <h3 className="text-sm font-semibold sm:text-base">Momentum &gt; Permission</h3>
            <p className="text-xs text-white/80 sm:text-sm">If something should exist, build it.</p>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-brandCP sm:text-base">#WeAreNotWaiting</h3>
            <p className="text-xs text-white/80 sm:text-sm">Because lives depend on what we build.</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-2 sm:space-y-3">
        ...
        <p className="text-sm text-white/80 sm:text-base">You don't need expertise to begin.</p>
        <p className="text-sm text-white/80 sm:text-base">You just need to care.</p>
        <blockquote className="my-4 rounded-sm border-l-4 border-brandCP py-1 pl-4 text-white/70 sm:my-6">
          <p className="text-sm italic sm:text-base">Welcome to MyTwin Lab.</p>
          <p className="text-sm italic sm:text-base">Unite to build what matters.</p>
          <p className="mt-2 text-sm font-semibold text-brandCP sm:text-base">#WeAreNotWaiting</p>
        </blockquote>
      </section>
    </div>
  );

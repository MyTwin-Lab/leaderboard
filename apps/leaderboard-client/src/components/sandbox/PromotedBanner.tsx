...
interface PromotedBannerProps {
  /** `promoted_challenge_id` — absent si la promotion précède le lien (jamais en pratique). */
 ...
 */
export function PromotedBanner({ challengeId, promotionBonusCp }: PromotedBannerProps) {
  return (
